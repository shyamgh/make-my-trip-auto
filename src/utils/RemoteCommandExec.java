...
*/		
/*	public void ExecuteCmdOntThisHost(String ip, String user, String pwd) throws IOException
	{
		String currentDir = new java.io.File( "." ).getCanonicalPath();
		File f = new File(currentDir+"\\scripts");
    	
    	//Assert.assertTrue(f.exists(), "Verify if the ruby script exists");
    	
    	
    	ProcessBuilder pb = new ProcessBuilder(currentDir+"\\scripts\\"+rubyscript); //, "myArg1", "myArg2");
		...
		command="C:\\Ruby192\\bin\\ruby.exe C:\\Automation_projects\\MakeMyTrip\\scripts\\executecmdonremoteserver.rb";
...
*/	
	...
	public ArrayList <String> ExecuteCmdOnThisHost(String hostIP, String user, String pwd, String command) throws IOException {
		CustomLogger.logMethodStart();	//To report method started
	    String rubyscript = EnvironmentVariables.SCRIPTS_PATH+"\\executecmdonremoteserver.rb" ;
	    //String command1="cmd /c "+EnvironmentVariables.rubyPath+"ruby.exe "+rubyscript+" -h "+hostIP+" -u "+user+" -p "+pwd+" -c "+command+"";
